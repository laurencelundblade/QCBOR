...
/**
 ...
 If floating-point usage is disabled this will set @ref QCBOR_ERR_FLOAT_DISABLED
...
/**
 ...
 error. If the QCBOR library is compiled with hw floating-point disabled,
 ...
 @ref QCBOR_ERR_FLOAT_DISABLED is set.
